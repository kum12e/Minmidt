...
*/
jQuery(document).ready(function($){$("#frontpage-slider").flexslider({animation:dynamicnews_slider_params.animation,slideshowSpeed:dynamicnews_slider_params.speed,namespace:"zeeflex-",selector:".zeeslides > li",smoothHeight:!0,controlsContainer:".frontpage-slider-controls"})});
